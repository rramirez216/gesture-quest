...
function ButtonWrapper({ handleClick, handlePause, handleSliderDisplay, pause, imageList, imageIndex }) {
  ...
  return (
    <div className=' absolute inset-x-0 bottom-0 m-auto max-w-min flex justify-center gap-1 md:gap-2 text-xl md:text-2xl text-slate-800 border border-slate-300 rounded-t-lg bg-slate-200 p-2 md:p-4'>
